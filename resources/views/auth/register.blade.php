...
{!! htmlScriptTagJsApi() !!}
<script src="{{asset('js/validate_form_register.js')}}"></script>
    ...
    <x-guest-layout>
        <x-authentication-card>
            ...
            <form method="POST" action="{{ route('register') }}"  id="registerForm">
                ...
                <div>
                    <br>
                    <x-label for="name" value="{{ __('Pais') }}" />
                    <select for="pais" name="pais" id="pais" class="block mt-1 w-full" required>
                ...
                <div class="flex items-center justify-end mt-4">
                    ...
                    <x-button class="g-recaptcha ml-4"  
            ...
            <p  class="flex items-center " id="mensaje"></p>
        </x-authentication-card>
