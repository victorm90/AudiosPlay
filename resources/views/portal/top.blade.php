...
<link rel="stylesheet" href="{{asset('css/card_Leaderboard.css')}}">
@endsection
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="feature-banner header-text">
									<div class="row">
										<div class="prueba col-lg-12 col-sm-12" style="text-align: center; margin-top: -5%;">
											<h3>MÁS VENDIDOS</h3></div>
										<div class="most-popular" style="background-color:#0A2647">
											<div class="row">
												<div class="col-lg-12">
													<div class="row">
														<div class="leaderboard ">
															<div class="header_card"> <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.999 511.999" style="enable-background:new 0 0 511.999 511.999;" xml:space="preserve" class="leaderboard__icon">
                                  <g>
                                    <g>
                                  ...
                                  c1.727,3.497,5.062,5.921,8.922,6.482l18.162,2.64L278.064,146.405z" />
																...
																<h1 class="leaderboard__title"><span class="leaderboard__title--top">Google Play</span><span class="leaderboard__title--bottom"></span></h1> </div>
															<main class="leaderboard__profiles">
																<div style="margin: 0 auto;">
																	<p style="color: #000000; font-size:20px;">{{ Carbon::now()->translatedFormat('F \de Y') }}</p><br>
                                 </div> 
                                  @foreach ($tops as $top) 
                                    @if ($top->posicion > 0 && $top->posicion<50) <article class="leaderboard__profile"> <img src="{{asset($top->audios->imagen)}}" alt="Mark Zuckerberg" class="leaderboard__picture">
                                    <a href="{{ route ('portal.detalles',$top->audios->slug)}}">
                                      <div class="col-md-12 text-center"> <span class="leaderboard__texto">  {!! Str::limit($top->audios->titulo, 29) !!}</span> </div>
                                    </a> <span class="leaderboard__value">{{$top->posicion}}<span></span></span>
                                    </article> 
                                    @endif 
                                  @endforeach 
                              </main>
										...
										<!-- ***** Most Popular End ***** --><br><br> <br><br> </div>
								</div>
							</div>
						</div>
						<!-- ***** Featured End ***** -->
